# EstateFlow Database - Updated Complete Table Listing (15 Tables)
...
- **NVarChar(Max)** = Variable-length Unicode string (unlimited)
...
|----------|--------|-------|
| Authentication | Roles, Users | 2 |
| Customer Management | Customers, PaymentTransactions, Clients | 3 |
| Appointments & Scheduling | Appointments, ViewingAppointments, Schedules | 3 |
| Property Management | Properties, Brokers, Transactions | 3 |
| Business Operations | Commissions, Invoices, Payroll | 3 ✅ NEW |
| Security | OtpVerifications | 1 |
| **TOTAL** | | **15** |
...
Clients (1) ──→ (M) Transactions (BuyerId/SellerId)

Properties (1) ──→ (M) Transactions
Properties (1) ──→ (M) ViewingAppointments

Transactions (1) ──→ (M) Commissions ✅ NEW
Transactions (1) ──→ (M) Invoices ✅ NEW

Brokers (1) ──→ (M) Commissions ✅ NEW
Brokers (1) ──→ (M) Invoices ✅ NEW
Brokers (1) ──→ (M) Payroll ✅ NEW

Users (1) ──→ (M) Payroll ✅ NEW
```

---

**Database Name:** DB_Real_Estate  
**Total Tables:** 15 (Updated)  
**Total Fields:** 200+  
**Status:** Production Ready  
**Last Updated:** 2026  
**NEW Tables:** 3 (Commissions, Invoices, Payroll)
